...
export default function CheckoutPage() {
    ...
    return (
      ...
      >
        <div className="text-center">
          <h1
            className={`text-4xl font-caudex font-bold mb-4 ${
  ...
  return (
    <div
      className={`font-caudex md:px-8 flex-1 flex items-center justify-center min-h-0 mt-20 xl:mt-10 mb-20 xl:mb-0 ${
        ...
        {paymentSuccess ? (
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-4 p-6 bg-green-500/20 border border-green-500 rounded">
              ...
              <p
                className={`text-lg font-caudex mt-4 ${
                  isLight ? "text-black/70" : "text-white/70"
                }`}
              >
          ...
          <div className="flex flex-col xl:flex-row justify-center items-center lg:items-start gap-22 xl:gap-52 px-8">
            ...
            <div className="w-full xl:w-[60%]">
              <h2
                className={`text-2xl font-caudex font-bold text-center mb-6 ${
                  isLight ? "text-black" : "text-white"
                }`}
              >
                Cart Items
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h3
                        className={`text-xl font-caudex font-semibold mb-2 ${
                          isLight ? "text-black" : "text-white"
                        }`}
                      >
                        {item.title}
                      ...
                      <p
                        className={`text-lg font-caudex font-bold ${
                          isLight ? "text-black" : "text-white"
                        }`}
                      >
                        {item.price} SEK
              ...
              >
                <div
                  className={`flex justify-between items-center text-2xl font-caudex font-bold ${
                    isLight ? "text-black" : "text-white"
                  }`}
                >
                  <span>Total:</span>
            ...
            <div className="w-full xl:w-[30%]">
              <h2
                className={`text-2xl font-caudex font-bold mb-6 text-center ${
                  isLight ? "text-black" : "text-white"
                }`}
              >
                ...
                <div className="mt-6">
                  {paymentSuccess && (
                    <div className="h-[100px] mb-4 p-4 bg-green-500/20 border border-green-500 rounded flex flex-col justify-center">
                      ...
                      <p
                        className={`text-sm font-caudex mt-2 ${
                          isLight ? "text-black/70" : "text-white/70"
                        }`}
                      >
                        Thank you for your purchase!
                  ...
                  <div className="h-[200px]">
                    {!createdOrderId ? (
                      <>
                        ...
                        >
                          Fill in your shipping information to proceed with
                          PayPal payment.*
                        </p>
                        <button
                          type="submit"
                          ...
                          <>
                            {paymentError && (
                              <div className="mb-4 p-4 bg-red-500/20 border border-red-500 rounded">
                                ...
                                <p
                                  className={`text-sm font-caudex mt-1 ${
                                    isLight ? "text-black/70" : "text-white/70"
                                  }`}
                                >
                                  {paymentError}
