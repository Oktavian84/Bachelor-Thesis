...
export function ExhibitionBlock({
  ...
  return (
    <section
      className={`w-full flex items-center pt-28 xl:pt-35 ${
        isLight ? "bg-white" : "bg-black"
      }`}
    >
      <div className="w-full flex flex-col xl:flex-row xl:items-center">
        <div className="w-full h-auto xl:w-[50%] xl:h-[65vh] xl:px-14 xl:ml-8 2xl:w-[45%] 2xl:h-[65vh] 2xl:px-16 2xl:ml-10 flex items-center">
          <div className="p-8 xl:p-12 w-full flex flex-col justify-center">
            <h2
              className={`font-caudex text-center text-4xl font-bold mb-8 ${
                isLight ? "text-black" : "text-white text-shadow-lg/30"
              }`}
            >
              {exhibition.title}
            </h2>
            ...
            {(exhibition.date || exhibition.time) && (
              <div className="md:flex justify-evenly mb-8 text-center">
                {exhibition.date && (
                  <p
                    className={`font-caudex text-xl mb-2 md:mb-0 ${
                      isLight ? "text-black" : "text-white text-shadow-lg/30"
                    }`}
                  >
            ...
            <div
              className={`font-caudex text-base md:text-xl text-center leading-relaxed mb-6 whitespace-pre-line ${
                isLight ? "text-black" : "text-white text-shadow-lg/30"
              }`}
            >
            ...
            <div className="relative w-full h-full rounded-tl-[8rem] rounded-bl-[8rem] overflow-hidden">
              ...
              {submitStatus === "success" && (
                <div className="absolute top-0 left-10 md:left-0 right-0 p-6 text-center">
                  <p
                    className={`font-caudex text-2xl lg:text-3xl ${
                      isLight ? "text-black" : "text-white text-shadow-lg/30"
                    }`}
                  >
            ...
            <div className="relative rounded-tl-[8rem] rounded-bl-[8rem] p-12 h-full flex flex-col justify-center overflow-hidden">
              ...
              >
                ...
                <div className="max-w-fit mx-auto">
                  <p
                    className={`font-caudex text-center text-2xl lg:text-3xl mb-6 md:mb-20 -mt-4 ${
                      isLight ? "text-black" : "text-white text-shadow-lg/30"
                    }`}
                  >
                  ...
                  <div>
                    <label
                      htmlFor="name"
                      className={`block font-caudex text-xl sm:text-2xl mb-2 ${
                        isLight ? "text-black" : "text-white text-shadow-lg/30"
                      }`}
                    >
                      Name
