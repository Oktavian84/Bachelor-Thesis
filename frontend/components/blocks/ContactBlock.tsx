  ...
  return (
    <section className="w-full bg-black flex items-center pt-30">
      <div className="w-full flex flex-col xl:flex-row">
            ...
            <div className="relative w-full h-full rounded-tr-[8rem] rounded-br-[8rem] overflow-hidden">
              ...
              {submitStatus === "success" && (
                <div className="absolute top-0 right-10 xl:left-10 md:left-0 md:right-0 p-6 text-center">
                  <p className="text-white text-2xl lg:text-4xl text-shadow-lg/30">
            ...
            <div className="relative rounded-tr-[8rem] rounded-br-[8rem] p-12 h-full flex flex-col justify-center overflow-hidden">
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-6 relative z-10">
                ...
                <div className="max-w-fit mx-auto">
                  <p className="text-white text-center text-2xl lg:text-3xl mb-10 md:mb-15 mt-4 text-shadow-lg/30">
                  ...
                  <div className="mt-6">
                    <label htmlFor="message" className="block text-white text-xl mb-2 text-shadow-lg/30">
                      Message
                    </label>
                    <FormInput
                      name="message"
        ...
        <div className="w-full xl:w-[35%] -mt-40 xl:mt-0 ml-auto order-1 xl:order-2">
          <div className="p-6 xl:p-12 h-[75vh] flex flex-col justify-center items-center xl:items-start">
            <h2 className="text-white text-4xl font-bold mb-8 text-center xl:text-left">{headline}</h2>
            <div className="text-white text-2xl sm:text-3xl leading-relaxed mb-14 whitespace-pre-line text-center xl:text-left">
              <ReactMarkdown>{content}</ReactMarkdown>
            </div>
            <div className="flex items-center justify-center xl:justify-start mb-12">
              {cta && cta.length > 0 && (
                <div className="flex gap-4 mr-22">
                  {cta.map((link, index) => (
                    <Link
                      key={link.id}
                      href={link.href}
              ...
              <button
                ...
                className={`bg-black text-white px-8 py-2 rounded-lg text-xl font-bold border border-white hover:bg-white hover:text-black hover:border-black hover:scale-110 shadow-sm shadow-white ${
                  showForm 
